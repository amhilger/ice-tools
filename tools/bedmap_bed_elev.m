function [bed_elev] = bedmap_bed_elev(lat_or_x, lon_or_y)
...
%easts and norths
[bmx, bmy, bm_bed] = ... %pad with 5 km extra to ensure good interp
    bedmap2_data('bedw',x, y, 5,'xy');
%interpolate the along-transect value from the gridded BEDMAP
%values
bed_elev = interp2(bmx, bmy, bm_bed, ...
                    x, y, 'linear');
